...
<div class="about">
	<div class="about-top">
		<img class="about-top-arrow" src="<?php echo get_theme_file_uri(); ?>/images/left-arrow.png">
		<p class="about-top-str">About</p>
		<img class="about-top-arrow" src="<?php echo get_theme_file_uri(); ?>/images/right_arrow.png">
	</div>
	<div class="about-top-title-wrapper">
		<p class="about-top-title">Mission</p>
	</div>
	<p class="about-top-description">
		吾輩わがはいは猫である。名前はまだ無い。どこで生れたかとんと見当けんとうがつかぬ。何でも薄暗いじめじめした
...
<div class="greeting">
	<div class="greeting-title-wrapper">
		<p class="greeting-title">代表からのご挨拶</p>
	</div>
	<div class="greeting-contents">
		<p class="greeting-discription">
